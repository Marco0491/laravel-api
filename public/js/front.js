...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    getPost: function getPost() {
      ...
      axios.get('http://127.0.0.1:8000/api/post').then(function (result) {
        _this.postArray = result.data.data;
...
// module
exports.push([module.i, "div.card[data-v-5e8280ea] {\n  width: 100%;\n}", ""]);
...
var render = function () {
  ...
  return _c("div", { staticClass: "container-fluid p-5" }, [
    _c(
      ...
      _vm._l(_vm.postArray, function (element, index) {
        return _c("Post", { key: index, attrs: { post: element } })
      }),
      1
    ),
  ])
...
module.exports = __webpack_require__(/*! /Users/h3llboy/Desktop/Boolean/Corso Full Time/laravel-api/resources/js/front.js */"./resources/js/front.js");
